...
const LabelTextarea = ({ label, placeholder, inputPadding, rows,width, fontweight, handleChange, name, value }) => {
	return (
		<LabelInput
        width={width}
		...
		>
			<textarea
                ...
                value={value && value}
                name={name}								
				style={{ border: "none", outline: "none", resize: "none", padding:inputPadding }}
