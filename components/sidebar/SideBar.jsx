...
const SideBar = ({btn, sideBarShow}) => {
	return (
		<div
			className={`bg-white md:bg-transparent  animate05s md:translate-x-0  h-screen md:h-full md:block hidden top-0 left-0 z-50 md:z-0 pt-[40px] md:static w-full md:w-[345px]  ${btn ? "md:mt-[-26px]" : "md:mt-[-32px]"}`}
			style={{
